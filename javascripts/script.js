const cont = () => {
  ...
  about.from(
    '.about h1, .about h3, .about p, .about-button',
  ...
  wwd.from('.wwd h1, .wwd h3, .wwd-text1, .wwd-text2', {
    x: '-75%',
    opacity: 0,
    duration: 1,
    stagger: 0.15,
  ...
  menu.from('.menu h1, .menu h3, .menu p, .menu-button', {
    y: '75%',
    duration: 1,
    opacity: 0,
    stagger: 0.1,
  ...
  reserv.from('.reserv h1, .reserv-button', {
    x: '-50%',
    duration: 1,
    opacity: 0,
    stagger: 0.15,
  ...
  benefits.from(
    '.benefits h1, .benefits h3, .benefits p, .benefits-button',
    { y: '50%', duration: 1, opacity: 0, stagger: 0.15 },
    '-=0.25'
  );
  ...
  rew.from(
    '.reviews h1, .reviews h3, .reviews-text, .reviews-sign, .reviews-star img',
  ...
  contact.from(
    '.contact h1, .contact h3, .contact input, .contact textarea, .contact button',
    { y: '75%', duration: 1, opacity: 0, stagger: 0.18 }
  );
