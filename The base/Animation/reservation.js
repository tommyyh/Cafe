...
tl.from(".r-lp h1, .r-lp p", {y: "100%", duration: 0.80, opacity: 0, stagger: 0.25});
...
reservation.from(".reservation h1, .reservation h3, .reservation input, .reservation button", {y: "75%", duration: 1, opacity: 0, stagger: 0.15});
