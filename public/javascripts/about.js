const cont = () => {
  ...
  beanery.from('.beanery h1, .beanery h3, .beanery-text1, .beanery-text2', {
    y: '65%',
    duration: 1,
    opacity: 0,
    stagger: 0.15,
  ...
  beanery.from(
    '.history-img-d',
    { y: '75%', duration: 1, opacity: 0 },
    '-=0.75'
  );
  history.from(
    '.history-rect-d',
    { x: '75%', duration: 1, opacity: 0 },
    '-=0.4'
  );
  history.from('.history h1, .history h3, .history p', {
    y: '50%',
    duration: 1,
    opacity: 0,
    stagger: 0.18,
  ...
  staff.from('.staff-slope, .staff-info', {
    y: '50%',
    duration: 1,
    opacity: 0,
    stagger: 0.2,
  ...
  access.from(
    '.access h1, .access h3, .access-open, .access-tel, .access-address',
    { y: '67%', duration: 1, opacity: 0, stagger: 0.15 }
  );
